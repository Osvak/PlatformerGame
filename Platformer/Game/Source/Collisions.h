...
public:
	...
	Collider* AddCollider(SDL_Rect rect, Collider::ColliderType type, Module* listener = nullptr);
...
private:
	// Array with all the Colliders
	Collider* colliders[MAX_COLLIDERS] = { nullptr };

	// The collision matrix. Defines the interaction for two collider types
	// If set two false, collider 1 will ignore collider 2
	bool matrix[Collider::ColliderType::MAX][Collider::ColliderType::MAX];
